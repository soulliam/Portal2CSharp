...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <script type="text/javascript">
    ...
    <div style="width:100%;height:100%;text-align:center;margin: 0 auto">
        ...
        <iframe id="thisFrame" src="http://192.168.0.9:8282/login.aspx?ReturnUrl=%2fRestricted%2fvehicleSearch.aspx" style="width:1020px;background: transparent;border:none;" ></iframe>
    </div>
</asp:Content>
