...
public partial class Dashboard : System.Web.UI.Page
{
    ...
    protected void GetWeather()
    {
        ...
        var Headernames = doc.DocumentNode.SelectNodes("//*[@class='ZINbbc xpd O9g5cc uUPGi']").ToList();
        ...
        Headernames = doc.DocumentNode.SelectNodes("//div[@class='ZINbbc xpd O9g5cc uUPGi']").ToList();
