    ...
    var source =
                    {
                        ...
                        url: "http://localhost:52839/api/ReservationReports/GetReservationReport/" + 9,
                        datatype: 'json'
                    };
    ...
    var source =
                    {
                        ...
                        url: 'https://www.jqwidgets.com/jquery-widgets-demo/demos/interactivedemos/businessdashboard/data.php?usedwidget=chartperformance1',
                        datatype: 'json'
                    };
    ...
    var source =
                    {
                        ...
                        url: 'https://www.jqwidgets.com/jquery-widgets-demo/demos/interactivedemos/businessdashboard/data.php?usedwidget=profitloss',
                        datatype: 'json'
                    };
        ...
        source =
            {
                ...
                url: 'https://www.jqwidgets.com/jquery-widgets-demo/demos/interactivedemos/businessdashboard/data.php?usedwidget=' + dataToDisplay,
                datatype: 'json'
            };
        ...
        source =
            {
                ...
                url: 'https://www.jqwidgets.com/jquery-widgets-demo/demos/interactivedemos/businessdashboard/https://www.jqwidgets.com/jquery-widgets-demo/demos/interactivedemos/businessdashboard/data.php?usedwidget=' + dataToDisplay,
                datatype: 'json'
            };
