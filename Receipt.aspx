				        ...
				        <div id="receipt" >
					        <div style='border:solid 1px black;width:185px;padding:2px;'>
						        <table style='font-family:Tahoma; font-size:8pt; background-color: white;width:180px;padding:7px;'>
							        ...
							        <tr>
								        <td colspan='2'>
									        <div id="receiptDateInfo" style="text-align:center;font-weight:bold;">--/--/---- --:-- PM</div>
								        </td>
							        </tr>
							        <tr>
								        <td colspan='2'>
									        <div id="locationInfo"style="text-align:center;font-weight:bold;">------ FastPark</div>
								        </td>
							        </tr>
							        <tr>
								        <td colspan='2'>
							        ...
							        <tr>
								        <td colspan='2'>
									        <div id="telephoneInfo"style="text-align:center;font-weight:bold;">xxx-xxx-xxxx</div>
								        </td>
							        </tr>
							        <tr>
								        <td colspan='2'>
							        ...
							        <tr>
								        ...
								        <td>
									        <div id="amountDueInfo">$00.00</div>
								        </td>
							        </tr>
							        <tr>
								        <td>
							        ...
							        <tr>
								        ...
								        <td>
									        <div id="paymentInfoAmtInfo">$00.00</div>
								        </td>
							        </tr>
							        <tr>
								        <td colspan='2'>
